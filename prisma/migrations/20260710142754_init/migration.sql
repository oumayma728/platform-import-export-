-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('pass');
...
-- CreateIndex
CREATE INDEX "conversations_exporter_company_id_idx" ON "conversations"("exporter_company_id");

-- CreateIndex
CREATE INDEX "conversations_importer_company_id_idx" ON "conversations"("importer_company_id");
