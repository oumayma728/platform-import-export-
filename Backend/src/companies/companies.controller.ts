...
import { ReviewsSummaryResponseDto } from '../admin/dashboard/dto/admin-dashboard-response.dto';
...
export class CompaniesController {
  ...
  @ApiOperation({
    summary: 'Get reviews summary for a company',
    description:
      'Returns the average rating and total review count for a company. ' +
      'averageRating is null when no reviews exist yet. ' +
  ...
  @ApiOkResponse({
    description: 'Reviews summary returned successfully.',
    type: ReviewsSummaryResponseDto,
  })
  @ApiNotFoundResponse({
  ...
  async getReviewsSummary(
    ...
    return this.companiesService.getReviewsSummary(id);
  }
}
